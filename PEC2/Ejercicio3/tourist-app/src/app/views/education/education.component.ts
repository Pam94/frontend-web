...
export class EducationComponent implements OnInit {
  ...
  async save(): Promise<boolean | Education> {
    ...
    if(this.education.id) {
      return this.usersService.updateEducation(this.education).toPromise()
      .then(() => this.router.navigateByUrl('/profile'))
    } else {
      return this.usersService.addEducation(this.education).toPromise()
      .then(() => this.router.navigateByUrl('/profile'))
    }
  ...
  getEducation(): void {
    ...
    this.usersService.getEducation(id)
      .subscribe(education => {
